...
import { FiPlus, FiUsers, FiStar, FiEdit, FiTrash, FiToggleLeft, FiToggleRight, FiImage } from 'react-icons/fi';
          ...
          {filteredSeasons.length === 0 ? (
            ...
            <div className="divide-y">
              {filteredSeasons.map((season) => (
                <div key={season._id} className="p-6 hover:bg-gray-50 transition-colors">
